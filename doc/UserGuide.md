...
>
> The address of each person has to obey certain rules, which means that there will be in format of "block,
> street, unit, postal code"
> 
> Persons can have any number of tags (including 0)

Examples: 
* `add John Doe p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01, 119277`
